              ...
              return (
                ...
                >
                  {isAdmin && (
                   ...
                   <TableCell>
                     <div className="flex items-center gap-2 md:gap-3">
                       <div className="w-8 h-8 md:w-10 md:h-10 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                         <span className="mobile-text-tiny font-medium">
                           {product.name.charAt(0)}
                         </span>
                       </div>
                       <div className="min-w-0">
                         <p className="font-medium mobile-text-small truncate">{product.name}</p>
                         {product.description && (
                   ...
                   <TableCell>
                     <code className="mobile-text-tiny bg-muted px-1 md:px-2 py-0.5 md:py-1 rounded">
                       {product.sku}
                     </code>
                   </TableCell>
                   
                   <TableCell>
                     <Badge variant="outline" className="mobile-text-tiny">
                       {product.category}
                     </Badge>
                   </TableCell>
