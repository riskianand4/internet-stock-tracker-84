...
const ProductCard = ({
  ...
  return <div className="relative">
      <Card className="glass hover-lift border-border/50 overflow-hidden group cursor-pointer h-[400px] flex flex-col" onClick={() => onView?.(product)}>
        ...
        <CardContent className="mobile-padding-compact space-y-2 md:space-y-3 flex-1 flex flex-col">
          ...
          <div className="space-y-1 mobile-text-tiny text-muted-foreground flex-1">
          ...
          {/* Supplier */}
          {product.supplier && <div className="pt-1 md:pt-2 border-t border-border/50">
              <p className="mobile-text-tiny text-muted-foreground">
