...
import { useConsolidatedProductManager } from '@/services/consolidatedProductManager';
...
const ProductsManager = () => {
  ...
  // Use consolidated product manager hook for API data
  const {
    products,
    isLoading,
    isFromApi,
  ...
  return <div className="min-h-screen bg-muted/10 mobile-responsive-padding py-3 md:py-6">
      ...
      y: 0
        ...
        <ProductDetailModal product={selectedProduct} open={isDetailModalOpen} onOpenChange={setIsDetailModalOpen} mode={modalMode} onModeChange={setModalMode} updateProduct={updateProduct} isLoading={isLoading} />
      </motion.div>
    </div>;
};
