  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-sm md:text-md font-bold">{stats.totalRequests.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm md:text-md font-bold">{Math.round(stats.averageResponseTime)}ms</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm md:text-md font-bold text-red-600">{stats.failedRequests}</div>
            <p className="text-xs text-muted-foreground">
