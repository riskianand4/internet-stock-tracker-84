  ...
  return <div className="min-h-screen bg-muted/10 px-2 sm:px-4 md:px-6 py-4 md:py-6 lg:py-8 lg:px-0">
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-7xl mx-auto space-y-3 sm:space-y-4 lg:space-y-6 px-2 sm:px-4">
        ...
        <motion.div variants={itemVariants} className="text-center px-2 sm:px-4">
          <h1 className="text-sm md:text-md lg:text-lg font-bold text-primary mb-2 sm:mb-4">
            Dashboard Analitik Lanjutan
          </h1>
          <p className="text-muted-foreground text-xs sm:text-sm md:text-sm max-w-2xl mx-auto">
