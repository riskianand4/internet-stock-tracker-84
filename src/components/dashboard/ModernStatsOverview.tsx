          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm md:text-md font-bold text-foreground">{formatCurrency(stats.totalValue)}</p>
                <div className="flex items-center space-x-1 mt-1">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm md:text-md font-bold text-foreground">{formatCurrency(stats.averageValue)}</p>
                <div className="flex items-center space-x-1 mt-1">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm md:text-md font-bold text-foreground">
