        ...
        <div className="space-y-3 sm:space-y-6">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              {isEditing ? (
                ...
                <h2 className="text-sm sm:text-lg font-bold text-foreground">{product.name}</h2>
              )}
              <p className="text-xs sm:text-sm text-muted-foreground font-mono mt-1">{product.sku}</p>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3">
                {isEditing ? (
                  <>
                    <div>
                      <Label htmlFor="stock" className="text-xs sm:text-sm">Stok Saat Ini</Label>
                      <Input
                        id="stock"
                        type="number"
                    ...
                    <div>
                      <Label htmlFor="minStock" className="text-xs sm:text-sm">Minimum Stok</Label>
                      <Input
                        id="minStock"
                        type="number"
                  ...
                  <>
                     <div className="flex justify-between">
                       <span className="text-xs sm:text-sm text-muted-foreground">Stok Saat Ini:</span>
                      <span className="text-xs sm:text-sm font-semibold">{product.stock} unit</span>
                    </div>
                     <div className="flex justify-between">
                       <span className="text-xs sm:text-sm text-muted-foreground">Minimum Stok:</span>
                      <span className="text-xs sm:text-sm font-semibold">{product.minStock} unit</span>
                    </div>
                  </>
                )}
                
                 <div className="flex justify-between">
                   <span className="text-xs sm:text-sm text-muted-foreground">Kategori:</span>
                  <span className="text-xs sm:text-sm font-semibold">{product.category}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-3">
                {isEditing ? (
                   ...
                   <div className="flex justify-between">
                     <span className="text-xs sm:text-sm text-muted-foreground">Harga:</span>
                    <span className="text-xs sm:text-sm font-semibold text-primary">{formatPrice(product.price)}</span>
                  </div>
                )}
                ...
                {product.supplier && (
                   <div className="flex items-center space-x-2">
                     ...
                     <span className="text-xs sm:text-sm">{product.supplier}</span>
                   </div>
                )}
              </div>
            </div>
          ...
          {(product.description || isEditing) && (
            <>
              <Separator />
              <div>
                <h3 className="text-xs sm:text-sm font-semibold text-foreground mb-3">Deskripsi</h3>
                {isEditing ? (
                  <Textarea
