            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{movementDetail.product?.name || 'Unknown Product'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">Kode Produk</label>
                  <p className="font-mono text-sm">{movementDetail.product?.sku || 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p>{movementDetail.location?.from?.warehouse || movementDetail.location?.to?.warehouse || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">User</label>
                  <p>{movementDetail.createdBy?.name || 'Unknown User'}</p>
                </div>
              </div>
