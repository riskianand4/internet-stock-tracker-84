...
export const SidebarSkeleton = () => (
  <div className="w-60 h-full border-r border-border bg-background p-4 space-y-4">
    {/* Logo area */}
...
export const HeaderSkeleton = () => (
  <header className="h-14 border-b border-border bg-card/50 backdrop-blur-xl flex items-center justify-between px-6">
...
export const MobileLayoutSkeleton = () => (
...
export const LayoutSkeleton = ({ isMobile = false }: { isMobile?: boolean }) => {
  if (isMobile) {
