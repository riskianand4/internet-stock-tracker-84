...
import { 
  ...
  Shield, Bell, Plug, Eye, Edit, Trash2, RefreshCw, Key
} from 'lucide-react';
            ...
            <TabsContent value="security" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Konfigurasi keamanan sistem dan akun</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="grid gap-4">
                    <h4 className="font-medium text-foreground">Pengaturan Sistem</h4>
